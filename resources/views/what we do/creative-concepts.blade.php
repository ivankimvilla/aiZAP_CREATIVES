...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>Creative Concepts - aiZAP CREATIVES</title>
    ...
    <body class="page-main antialiased">
        <div class="container">
            ...
            <div class="hero-left">
                <h1 class="hero-title">Creative Concepts</h1>
                <p class="hero-sub">Big ideas and strategic creative frameworks that guide memorable campaigns.</p>
            </div>
                  @include('partials.what-we-do-nav')
        </section>{{-- ============ WHAT WE DO (links) ============ --}}  
                    @include('partials.category-projects', ['category' => 'creative-concepts', 'label' => 'Creative Concepts'])
