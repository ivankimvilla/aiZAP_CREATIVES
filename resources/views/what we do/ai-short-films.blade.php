...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>AI Short Films - Aizap Creatives Studios</title>
        <link rel="stylesheet" href="{{ asset('css/what we do/ai-short-films.css') }}" />
    ...
    <body class="page-main antialiased">
        <div class="container">
            ...
            <div class="hero-left">
                <h1 class="hero-title">AI Short Films</h1>
                <p class="hero-sub">Short-form cinematic pieces created with AI-assisted production techniques.</p>
            </div>
               @include('partials.what-we-do-nav')
        </section>{{-- ============ WHAT WE DO (links) ============ --}}
              @include('partials.category-projects', ['category' => 'ai-short-films', 'label' => 'AI Short Films'])
