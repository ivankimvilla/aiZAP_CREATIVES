...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>Scriptwriting - Aizap Creatives Studios</title>
       <link rel="stylesheet" href="{{ asset('css/what we do/scriptwriting.css') }}" />
    </head>
    <body class="page-main antialiased">
        <div class="container">
            ...
            <div class="hero-left">
                <h1 class="hero-title">Scriptwriting</h1>
                <p class="hero-sub">Compelling scripts and narrative structures crafted for impact and clarity.</p>
            </div>
              @include('partials.what-we-do-nav')
        </section>{{-- ============ WHAT WE DO (links) ============ --}}
              @include('partials.category-projects', ['category' => 'scriptwriting', 'label' => 'Scriptwriting'])
