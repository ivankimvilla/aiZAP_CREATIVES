...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>UGC-style AI Videos - aiZAP CREATIVES</title>
    ...
    <body class="page-main antialiased">
        <div class="container">
            ...
            <div class="hero-left">
                <h1 class="hero-title">UGC-style AI Videos</h1>
                <p class="hero-sub">Authentic, user-generated style videos produced with AI to feel native and credible.</p>
            </div>
               @include('partials.what-we-do-nav')
        </section>{{-- ============ WHAT WE DO (links) ============ --}}
                    @include('partials.category-projects', ['category' => 'ugc-style-ai-videos', 'label' => 'UGC-style AI Videos'])
