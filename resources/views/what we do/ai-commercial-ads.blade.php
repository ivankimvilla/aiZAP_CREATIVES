...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>AI Commercial Ads - Aizap Creatives Studios</title>
        <link rel="stylesheet" href="{{ asset('css/what we do/ai-commercial-ads.css') }}" />
    ...
    <body class="page-main antialiased">
        <div class="container">
            ...
            <div class="hero-left">
                <h1 class="hero-title">AI Commercial Ads</h1>
                <p class="hero-sub">We craft high-impact AI-driven commercial ads that elevate brand storytelling and drive conversion.</p>
            </div>
              @include('partials.what-we-do-nav')
        </section>{{-- ============ WHAT WE DO (links) ============ --}}
                @include('partials.category-projects', ['category' => 'ai-commercial-ads', 'label' => 'AI Commercial Ads'])
