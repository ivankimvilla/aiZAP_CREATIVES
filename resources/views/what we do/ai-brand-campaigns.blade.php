...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>AI Brand Campaigns - aiZAP CREATIVES</title>
    ...
    <body class="page-main antialiased">
        <div class="container">
            ...
            <div class="hero-left">
                <h1 class="hero-title">AI Brand Campaigns</h1>
                <p class="hero-sub">Integrated AI-driven campaigns that align creative, targeting, and performance goals.</p>
            </div>
              @include('partials.what-we-do-nav')
        </section>{{-- ============ WHAT WE DO (links) ============ --}}
            @include('partials.category-projects', ['category' => 'ai-brand-campaigns', 'label' => 'AI Brand Campaigns'])
